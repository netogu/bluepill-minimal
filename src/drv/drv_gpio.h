...
#define Gpio_fast_pin_toggle(gpio, pin) gpio->ODR ^= (1 << pin);
#define Gpio_fast_pin_set(gpio, pin) gpio->BSRR |= (1 << pin);
#define Gpio_fast_pin_reset(gpio, pin) gpio->BRR |= (1 << pin);
